...
CREATE TABLE IF NOT EXISTS family_shopping_items (
  ...
  KEY idx_family_shopping_items_family_category (family_code, category_id),
  KEY idx_family_shopping_items_family_done (family_code, done),
...
CREATE TABLE IF NOT EXISTS family_ingredient_items (
  ...
  KEY idx_family_ingredient_items_family_category (family_code, category_id),
  KEY idx_family_ingredient_items_family_expire (family_code, expire_date),
